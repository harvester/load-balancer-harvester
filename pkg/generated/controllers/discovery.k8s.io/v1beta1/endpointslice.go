...
type EndpointSliceHandler func(string, *v1beta1.EndpointSlice) (*v1beta1.EndpointSlice, error)
...
type EndpointSliceClient interface {
	...
	Get(namespace, name string, options metav1.GetOptions) (*v1beta1.EndpointSlice, error)
	List(namespace string, opts metav1.ListOptions) (*v1beta1.EndpointSliceList, error)
	Watch(namespace string, opts metav1.ListOptions) (watch.Interface, error)
	Patch(namespace, name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.EndpointSlice, err error)
}

type EndpointSliceCache interface {
	Get(namespace, name string) (*v1beta1.EndpointSlice, error)
	List(namespace string, selector labels.Selector) ([]*v1beta1.EndpointSlice, error)

	AddIndexer(indexName string, indexer EndpointSliceIndexer)
	GetByIndex(indexName, key string) ([]*v1beta1.EndpointSlice, error)
}

type EndpointSliceIndexer func(obj *v1beta1.EndpointSlice) ([]string, error)
...
func FromEndpointSliceHandlerToHandler(sync EndpointSliceHandler) generic.Handler {
	return func(key string, obj runtime.Object) (ret runtime.Object, err error) {
		var v *v1beta1.EndpointSlice
		if obj == nil {
			v, err = sync(key, nil)
		} else {
			v, err = sync(key, obj.(*v1beta1.EndpointSlice))
		}
		if v == nil {
			return nil, err
		}
...
func (c *endpointSliceController) Updater() generic.Updater {
	return func(obj runtime.Object) (runtime.Object, error) {
		newObj, err := c.Update(obj.(*v1beta1.EndpointSlice))
		if newObj == nil {
			return nil, err
		}
		return newObj, err
...
func UpdateEndpointSliceDeepCopyOnChange(client EndpointSliceClient, obj *v1beta1.EndpointSlice, handler func(obj *v1beta1.EndpointSlice) (*v1beta1.EndpointSlice, error)) (*v1beta1.EndpointSlice, error) {
	if obj == nil {
		return obj, nil
	}
...
func (c *endpointSliceController) Create(obj *v1beta1.EndpointSlice) (*v1beta1.EndpointSlice, error) {
	result := &v1beta1.EndpointSlice{}
	return result, c.client.Create(context.TODO(), obj.Namespace, obj, result, metav1.CreateOptions{})
}

func (c *endpointSliceController) Update(obj *v1beta1.EndpointSlice) (*v1beta1.EndpointSlice, error) {
	result := &v1beta1.EndpointSlice{}
...
func (c *endpointSliceController) Get(namespace, name string, options metav1.GetOptions) (*v1beta1.EndpointSlice, error) {
	result := &v1beta1.EndpointSlice{}
	return result, c.client.Get(context.TODO(), namespace, name, result, options)
}

func (c *endpointSliceController) List(namespace string, opts metav1.ListOptions) (*v1beta1.EndpointSliceList, error) {
...
func (c *endpointSliceController) Patch(namespace, name string, pt types.PatchType, data []byte, subresources ...string) (*v1beta1.EndpointSlice, error) {
	result := &v1beta1.EndpointSlice{}
...
func (c *endpointSliceCache) Get(namespace, name string) (*v1beta1.EndpointSlice, error) {
...
func (c *endpointSliceCache) List(namespace string, selector labels.Selector) (ret []*v1beta1.EndpointSlice, err error) {
...
func (c *endpointSliceCache) AddIndexer(indexName string, indexer EndpointSliceIndexer) {
	utilruntime.Must(c.indexer.AddIndexers(map[string]cache.IndexFunc{
		indexName: func(obj interface{}) (strings []string, e error) {
			return indexer(obj.(*v1beta1.EndpointSlice))
		},
	}))
}

func (c *endpointSliceCache) GetByIndex(indexName, key string) (result []*v1beta1.EndpointSlice, err error) {
	objs, err := c.indexer.ByIndex(indexName, key)
	if err != nil {
		return nil, err
	}
	result = make([]*v1beta1.EndpointSlice, 0, len(objs))
	for _, obj := range objs {
		result = append(result, obj.(*v1beta1.EndpointSlice))
	}
	return result, nil
}
