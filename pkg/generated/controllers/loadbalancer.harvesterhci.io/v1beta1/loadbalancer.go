...
func FromLoadBalancerHandlerToHandler(sync LoadBalancerHandler) generic.Handler {
	return func(key string, obj runtime.Object) (ret runtime.Object, err error) {
		var v *v1beta1.LoadBalancer
		if obj == nil {
			v, err = sync(key, nil)
		} else {
			v, err = sync(key, obj.(*v1beta1.LoadBalancer))
		}
		if v == nil {
			return nil, err
		}
...
func (c *loadBalancerController) Updater() generic.Updater {
	return func(obj runtime.Object) (runtime.Object, error) {
		newObj, err := c.Update(obj.(*v1beta1.LoadBalancer))
		if newObj == nil {
			return nil, err
		}
		return newObj, err
...
func (c *loadBalancerController) Create(obj *v1beta1.LoadBalancer) (*v1beta1.LoadBalancer, error) {
	result := &v1beta1.LoadBalancer{}
	return result, c.client.Create(context.TODO(), obj.Namespace, obj, result, metav1.CreateOptions{})
}

func (c *loadBalancerController) Update(obj *v1beta1.LoadBalancer) (*v1beta1.LoadBalancer, error) {
	result := &v1beta1.LoadBalancer{}
	return result, c.client.Update(context.TODO(), obj.Namespace, obj, result, metav1.UpdateOptions{})
}

func (c *loadBalancerController) UpdateStatus(obj *v1beta1.LoadBalancer) (*v1beta1.LoadBalancer, error) {
	result := &v1beta1.LoadBalancer{}
...
func (c *loadBalancerController) Get(namespace, name string, options metav1.GetOptions) (*v1beta1.LoadBalancer, error) {
	result := &v1beta1.LoadBalancer{}
	return result, c.client.Get(context.TODO(), namespace, name, result, options)
}

func (c *loadBalancerController) List(namespace string, opts metav1.ListOptions) (*v1beta1.LoadBalancerList, error) {
...
func (c *loadBalancerController) Patch(namespace, name string, pt types.PatchType, data []byte, subresources ...string) (*v1beta1.LoadBalancer, error) {
	result := &v1beta1.LoadBalancer{}
...
func (c *loadBalancerCache) Get(namespace, name string) (*v1beta1.LoadBalancer, error) {
...
func (c *loadBalancerCache) List(namespace string, selector labels.Selector) (ret []*v1beta1.LoadBalancer, err error) {
...
func (c *loadBalancerCache) AddIndexer(indexName string, indexer LoadBalancerIndexer) {
	utilruntime.Must(c.indexer.AddIndexers(map[string]cache.IndexFunc{
		indexName: func(obj interface{}) (strings []string, e error) {
			return indexer(obj.(*v1beta1.LoadBalancer))
		},
	}))
}

func (c *loadBalancerCache) GetByIndex(indexName, key string) (result []*v1beta1.LoadBalancer, err error) {
	objs, err := c.indexer.ByIndex(indexName, key)
	if err != nil {
		return nil, err
	}
	result = make([]*v1beta1.LoadBalancer, 0, len(objs))
	for _, obj := range objs {
		result = append(result, obj.(*v1beta1.LoadBalancer))
	}
	return result, nil
}
