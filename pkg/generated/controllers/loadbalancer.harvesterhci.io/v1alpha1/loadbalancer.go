...
func (a *loadBalancerGeneratingHandler) isNewResourceVersion(obj *v1alpha1.LoadBalancer) bool {
	if !a.opts.UniqueApplyForResourceVersion {
		return true
	}
...
// Only used if UniqueApplyForResourceVersion is set in generic.GeneratingHandlerOptions
func (a *loadBalancerGeneratingHandler) storeResourceVersion(obj *v1alpha1.LoadBalancer) {
	if !a.opts.UniqueApplyForResourceVersion {
		return
	}
