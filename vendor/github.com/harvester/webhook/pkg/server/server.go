...
func (s *WebhookServer) RegisterValidators(validators ...admission.Validator) {
...
func (s *WebhookServer) RegisterMutators(mutators ...admission.Mutator) {
	s.mutators = append(s.mutators, mutators...)
}

// RegisterConverters registers converters to the webhook server.
// Call it before start the webhook server.
func (s *WebhookServer) RegisterConverters(converters ...conversion.Converter) {
